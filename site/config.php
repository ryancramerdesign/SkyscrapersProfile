...
// check to make sure this PW version is new enough for the skyscrapers profile
if(version_compare(ProcessWire::versionMajor . '.' . ProcessWire::versionMinor . '.' . ProcessWire::versionRevision, '2.2.12') < 0)
	throw new Exception("The skyscrapers site profile requires ProcessWire 2.2.12 or newer"); 
